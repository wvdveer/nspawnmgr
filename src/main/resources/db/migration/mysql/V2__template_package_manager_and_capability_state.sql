...
ALTER TABLE templates MODIFY COLUMN package_manager VARCHAR(20) NULL;
...
ALTER TABLE templates MODIFY COLUMN ssh_state VARCHAR(20) NOT NULL DEFAULT 'CAPABLE';
...
ALTER TABLE templates MODIFY COLUMN rdp_state VARCHAR(20) NOT NULL DEFAULT 'CAPABLE';
...
ALTER TABLE templates MODIFY COLUMN vnc_state VARCHAR(20) NOT NULL DEFAULT 'CAPABLE';
